...
const { isPlaying, currentTrack, imageUrl } = storeToRefs(useSong);
    ...
    >
      ...
      >
        <div class="flex items-center">
          <img class="rounded-full" width="27" :src="imageUrl" />
          <div class="text-white text-[14px] ml-1.5 font-semibold">69</div>
          <ChevronDown
            v-if="!openMenu"
            @click="openMenu = true"
            fillColor="#FFFFFF"
